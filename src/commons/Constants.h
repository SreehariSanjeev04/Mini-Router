...
namespace IPv4 {
enum class Protocol : uint8_t { ICMP = 1, TCP = 6, UDP = 17 };

constexpr uint8_t VERSION = 4;
constexpr uint8_t MINIMUM_HEADER_SIZE = 5;
}
namespace ICMP {
enum class Type : uint8_t { DEST_UNREACHABLE = 3 };
enum class Code : uint8_t { DEST_UNREACHABLE = 4 };
